...
\TODO{Check whether the PTU device (4.5)--(4.8) extracts exactly this
lower bound for free, or whether a dichotomy argument
($\theta_k\gtrless r_k^{-\delta}$) is needed. This is now the single
remaining gap in the tail analysis; read PTU \S4 line-by-line next.}
\end{proof}
